...
// import msfLogo32 from '../assets/images/msf-logo-32.webp';
// import msfLogo148 from '../assets/images/msf-logo-148.webp';
// import msfLogo68 from '../assets/images/msf-logo-68.webp';
// import msfLogo96 from '../assets/images/msf-logo-96.webp';
...
const HeroSection = () => {
  ...
  return (
    <section className='main-section relative mx-auto flex h-screen w-full max-w-7xl flex-col justify-between overflow-x-hidden bg-[#121212]'>
      ...
      <header className='relative z-10 mx-auto my-10 flex w-11/12 items-center justify-between'>
        ...
        <div className='relative flex gap-4 text-white'>
          <Button
            href='/MaganSingh_15_05_2026.pdf'
            download={true}
      ...
      <div className='mx-auto my-auto flex w-11/12 overflow-hidden'>
        ...
        {/* <img src={msfLogo96} // Fallback ke liye sabse badi image
          // 1. srcSet: Browser ko batayein ki aapke paas kaun-kaun se options hain
          srcSet={`${msfLogo148} 148w, ${msfLogo68} 296w, ${msfLogo96} 384w`}
          // 2. sizes: Browser ko batayein ki alag-alag screen par dabbe ka REAL size kya hai
          sizes="(max-width: 639px) 148px, 
         (max-width: 1023px) 272px, 
         384px"
          // 3. width & height: Hamesha max (desktop) size dein, isse aspect ratio lock rehta hai
          width={384}
          height={384}
          loading="eager"
          fetchpriority="high"
          ...
          aria-hidden="true"
          alt=""
          // 4. CSS: Yeh real-time mein dabbe ka size control karegi
          className="w-[148px] h-[148px] sm:w-68 sm:h-68 lg:w-96 lg:h-96 absolute top-1/4 md:top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 md:max-w-full object-contain opacity-20 pointer-events-none select-none"
        /> */}
        {/* <div
          className="absolute inset-0 flex justify-center pointer-events-none z-0 items-start pt-[33vh] md:items-center md:pt-0"
          style={{ contain: 'layout paint' }} //  Yeh browser ko layout recalculation se bachaega
        >
          <picture>
            ...
            <img
              ...
              loading="eager"
              decoding="async"
              className="w-[148px] h-[148px] sm:w-68 sm:h-68 lg:w-96 lg:h-96 md:max-w-full object-contain opacity-20 select-none"
            />
          </picture>
        </div> */}
        ...
        <div className='z-10 mx-auto flex w-full max-w-7xl items-center justify-between'>
          <div className='flex flex-col gap-1 px-2 text-white lg:gap-10'>
          ...
          {/* Social Icons Stack */}
          <ul className='flex flex-col gap-8 self-center px-4 text-[#b0b2c3] sm:self-auto lg:gap-24'>
            <li>
              <a
