...
import coderImage from '../assets/images/coder.svg';
import { IoClose } from 'react-icons/io5';

export default function AboutModal({ isModalOpen, onClose }) {
  useEffect(() => {
    ...
    <>
      ...
      <div className='fixed inset-0 z-50 overflow-y-auto bg-black/80' onClick={onClose}>
        <div className='w-full' onClick={(e) => e.stopPropagation()}>
          ...
          <div
            className='mx-auto w-full max-w-7xl place-items-center bg-zinc-900 px-2 py-2 pb-8'
            onClick={onClose}
          >
            <div
              className='w-full max-w-5xl rounded-2xl bg-[#232323] p-4'
              onClick={(e) => e.stopPropagation()}
            >
              <div className='x-icon flex justify-self-end'>
                <IoClose
                  onClick={onClose}
                  className='cursor-pointer text-3xl transition-all duration-300 hover:rotate-90 hover:text-blue-500'
                />
              </div>
              <div className='about-me flex w-full flex-col justify-center gap-4 sm:flex-row'>
                <div className='about-me-text w-full sm:w-3/5'>
                  <div className='px-1'>
                    ...
                    <div className='py-4'>
                      <h1 className='pb-2 text-3xl font-bold text-[#00f2fe]'>Experience</h1>
                      <h2 className='py-2 text-2xl font-bold text-[#00F2FE]'>Frontend Developer Intern</h2>
                    ...
                    <h1 className='py-4 text-xl font-bold text-[#00F2FE] sm:text-2xl'>
                      Frontend Technologies
                    </h1>
                    <ul className='about-me-detail flex w-full flex-wrap gap-x-3 gap-y-3'>
                      {frontendSkills.map((skill, index) => (
                        <li
                          key={index}
                          className='rounded-2xl border border-gray-700 bg-zinc-900 px-3 py-1.5 text-sm text-gray-300'
                        >
                          #{skill}
                        </li>
                      ))}
                    ...
                    <h1 className='py-4 text-xl font-bold text-[#00F2FE] sm:text-2xl'>Core Concepts</h1>
                    <ul className='about-me-detail flex w-full flex-wrap gap-x-3 gap-y-3'>
                      {coreConcepts.map((coreConcept, index) => (
                        <li
                          key={index}
                          className='text-md rounded-2xl border border-gray-700 bg-zinc-900 px-3 py-1.5 text-gray-300'
                        >
                          #{coreConcept}
                        </li>
                      ))}
                  ...
                  {/* <div className="top-skills flex flex-col gap-8 mt-4">
              <h2 className="mern font-bold text-blue-500 text-3xl">
                MERN STACK
              </h2>

              <div className="top-skills-icons flex gap-10 pl-8">
                <div className="mongodb-icon flex flex-col items-center gap-2 ">
                  <svg
                  ...
                  <h2 className="text-[#47a248] font-bold text-3xl">M</h2>
                </div>

                <div className="express-icon flex flex-col items-center gap-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 32 32"
                    width="50"
                  ...
                  <h2 className="font-bold text-3xl">E</h2>
                </div>

                <div className="react-icon flex flex-col items-center gap-2">
                  <svg
                    width="50"
                    height="50"
                  ...
                  <h2 className="text-[#61dafb] font-bold text-3xl">R</h2>
                </div>

                <div className="node-icon flex flex-col items-center gap-2">
                  <svg
                    width="50"
                    height="50"
                    viewBox="0 0 256 282"
                  ...
                  <h2 className="text-[#8cc84b] font-bold text-3xl">N</h2>
                </div>
              </div>
            </div> */}
                </div>

                <div className='flex w-full place-items-center sm:w-1/3'>
                  <img
                    className='h-96 w-96'
                    src={coderImage}
