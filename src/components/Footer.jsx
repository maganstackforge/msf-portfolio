const Footer = () => {
  return (
    <footer className='mx-auto flex w-full max-w-7xl flex-col items-center bg-[#050816] px-6 py-8 text-[#b0b2c3]'>
      {/* Logo */}
      <div className='mb-6'>
        <img
      ...
      {/* CTA */}
      <p className='mb-5 text-center text-sm text-[#d1d5db]'>
        Crafting fast, accessible, and modern web experiences.
      </p>
      ...
      <nav aria-label='Social Links'>
        <ul className='flex items-center justify-center gap-4 sm:gap-6'>
          {[
            ...
            {
              href: 'https://twitter.com/procoderx',
              label: 'Visit my X profile',
              viewBox: '0 0 512 512',
              path: 'M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z',
            },
            {
              href: 'https://www.instagram.com/procoderx',
            ...
            <li key={item.label}>
              <a
                ...
                className='inline-flex h-10 w-10 items-center justify-center rounded-full transition-all duration-300 hover:bg-white/10 hover:text-white'
              >
                <svg
                  className='h-5 w-5'
      ...
      <p className='text-center text-xs text-[#9ca3af]'>
        © {new Date().getFullYear()} ProCoderX. Designed & Developed by Magan Singh.
      </p>
    </footer>
  );
};
